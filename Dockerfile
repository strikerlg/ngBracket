...
##   $ docker build -t node-js-for-strikerlg-ngbracket-angularjs .
##
## RUNNING
##   $ docker run -p 3000:3000 node-js-for-strikerlg-ngbracket-angularjs
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="iztqb0t" \
    STACKSMITH_STACK_NAME="Node.js for strikerlg/ngBracket---angularjs" \
